        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            trailing: OutlineButton(
              ...
              child: Text("Publish", style: TextStyle(color: Colors.lightBlue, fontWeight: FontWeight.bold),),
            ),
          ),
        ],
      ),
        ...
        child: Column(
          children: <Widget>[
            ListTile(
              ...
              subtitle: Text(tAgo.format(timestamp.toDate()), style: TextStyle(color: Colors.grey),),
            ),
          ],
        ),
      ),
