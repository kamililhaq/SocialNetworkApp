...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>
{
  ...
  takeImage(mContext){
    return showDialog(
      ...
      builder: (context){
        return SimpleDialog(
          title: Text("New Post", style: TextStyle(color: Colors.lightBlue, fontWeight: FontWeight.bold),),
          children: <Widget>[
            SimpleDialogOption(
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          FlatButton(
            ...
            child: Text("Share", style: TextStyle(color: Colors.lightBlue, fontWeight: FontWeight.bold, fontSize: 16.0),),
          ),
        ],
      ),
      body: ListView(
