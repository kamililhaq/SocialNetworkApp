...
import 'package:kamililhaq/pages/EditProfilePage.dart';
import 'package:kamililhaq/pages/HomePage.dart';
import 'package:kamililhaq/widgets/HeaderWidget.dart';
import 'package:kamililhaq/widgets/PostTileWidget.dart';
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text(
                  ...
                  user.username, style: TextStyle(fontSize: 15.0, color: Colors.grey),
                ),
              ),
              Container(
                alignment: Alignment.centerLeft,
              ...
              Container(
                ...
                child: Text(
                  user.bio, style: TextStyle(fontSize: 15.0, color: Colors.grey),
                ),
              ),
            ],
          ),
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Icon(Icons.photo_library, color: Colors.grey, size: 50.0,),
            ),
            Padding(
              padding: EdgeInsets.only(top: 20.0),
              child: Text("No Posts", style: TextStyle(color: Colors.lightBlue, fontSize: 20.0, fontWeight: FontWeight.bold),),
            ),
          ],
        ),
      );
