...
import 'package:kamililhaq/pages/CommentsPage.dart';
import 'package:kamililhaq/pages/HomePage.dart';
import 'package:kamililhaq/pages/ProfilePage.dart';
import 'package:kamililhaq/widgets/CImageWidget.dart';
  ...
  createPostPicture()
  {
    return GestureDetector(
      ...
      child: Stack
        ...
        [
          Image.network(url),
          showHeart ? Icon(Icons.favorite, size: 140.0, color: Colors.lightBlue,) : Text(""),
        ],
      ),
    );
  }
